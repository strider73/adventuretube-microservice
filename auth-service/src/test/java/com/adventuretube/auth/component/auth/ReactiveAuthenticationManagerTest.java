package com.adventuretube.auth.component.auth;
...
/**
 * Component test for ReactiveAuthenticationManager.
 *
 * Loads ONLY the security config beans (AuthServiceConfig + CustomUserDetailService),
 * not the full application context. No JwtUtil, no AuthController, no env vars needed.
 */
