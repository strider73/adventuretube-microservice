...
public class MemberRouterConfig {
    ...
    public RouterFunction<ServerResponse> memberRoutes() {
        return route(POST("/member/registerMember"), this::registerMember)
                .andRoute(POST("/member/emailDuplicationCheck"), this::emailDuplicationCheck)
                .andRoute(POST("/member/findMemberByEmail"), this::findMemberByEmail)
                .andRoute(POST("/member/storeTokens"), this::storeToken)
                .andRoute(POST("/member/findToken"), this::findToken)
                .andRoute(POST("/member/deleteAllToken"), this::deleteAllToken)
                .andRoute(POST("/member/deleteUser"), this::deleteUser);
    }
