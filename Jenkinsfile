        ...
        stage('Run New Docker Image') {
            steps {
                script {
                    ...
                    def services = ["adventuretube-microservice-auth-service1",
                                    "adventuretube-microservice-member-service1",
                                    "adventuretube-microservice-geospatial-service1",
                                    "adventuretube-microservice-web-service1"]
