...
public class ServiceClient {
     ...
     *
     * Same WebClient chain as {@link #post} but returns {@code Mono<ServiceResponse<T>>}
     * instead of calling {@code .block()}, suitable for reactive pipelines.
     *
     * @param baseUrl      The service base URL (e.g., "http://MEMBER-SERVICE")
     * @param path         The endpoint path (e.g., "/member/registerMember")
     * @param body         The request body
     ...
     *
     * Same WebClient chain as {@link #get} but returns {@code Mono<ServiceResponse<T>>}
     * instead of calling {@code .block()}, suitable for reactive pipelines.
     *
     * @param baseUrl      The service base URL (e.g., "http://MEMBER-SERVICE")
     * @param path         The endpoint path
